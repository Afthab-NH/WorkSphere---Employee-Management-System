...
import { Calendar1Icon, ChevronRightIcon, DollarSignIcon, FileTextIcon, LayoutGridIcon, MenuIcon, SettingsIcon, UserIcon, XIcon } from 'lucide-react'
...
const Sidebar = () => {
    ...
    const navItems = [
        ...
        {name: "Attendence", href: "/attendence", icon: Calendar1Icon},
                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                        <UserIcon className='text-white size-7' />
                            <div>
                                <p className='font-semibold text-[13px] text-white tracking-wide'>Employee Management System</p>
